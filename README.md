...
Trong năm 2009, Internet Engineering Task Forec (IETF) đưa ra chuẩn syslog trong [https://tools.ietf.org/html/rfc5424](RFC 5424).

Syslog ban đầu sử dụng UDP, điều này là không đảm bảo cho việc truyền tin. Tuy nhiên sau  đó IETF đã ban hành [https://www.ietf.org/rfc/rfc3195.txt](RFC 3195 Reliable Delivery for syslog) - đảm bảo tin cậy cho syslog và [https://tools.ietf.org/html/rfc6587](RFC 6587 Transmission of Syslog Messages over TCP) - Truyền tải thông báo syslog qua TCP. Điều này có nghĩa là ngoài UDP thì giờ đây syslog cũng đã sử dụng TCP để đảm bảo an toàn cho quá trình truyền tin.
